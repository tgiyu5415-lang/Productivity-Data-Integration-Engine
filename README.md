...
![Platform](https://img.shields.io/badge/platform-Tampermonkey-green?style=flat-square)
...
> Developed to support high-volume QC pipelines processing **2,500+ items/day** with a target accuracy rate of **98–99%**.
